            ...
            <div class="navbar-collapse collapse">
              ...
              <security:authorize access="isAuthenticated()">
                       <security:authorize access="hasRole('ROLE_ADMINISTRATOR')">
                            <li><a href="${pageContext.request.contextPath}/member/addCompanyUser">Add User</a></li>
                       </security:authorize>
              ...
              <security:authorize access="!isAuthenticated()">
                ...
                <ul class="nav navbar-nav" style="position:fixed; right: 6%;">
                        ...
                        style="margin-top:5px; height: 40px; padding: 3px; border: 1px solid gray; border-radius: 50%;"/></li>
                           ...
                           <security:authorize access="isAuthenticated()">
						    <li><a href="${pageContext.request.contextPath}/home"> <security:authentication property="principal.username" /> </a> </li>
