...
import com.sample.contosojobs.ContosoJobsApplication.service.AuthenticationService;
...
public class ContosoSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		String[] resources = new String[]{
                ...
                ,"/member/registerUser/**","/member/registerCompany/**","/member/processCompanyForm/**", "/member/processForm/**"
		};
		// log in
