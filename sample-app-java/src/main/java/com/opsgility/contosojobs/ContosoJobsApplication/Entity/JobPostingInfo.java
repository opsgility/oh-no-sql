...
public class JobPostingInfo implements Serializable{
	...
	public JobPostingInfo(String jobPostingID, String companyID, String jobTitle, String companyName, String city,
	...
	public String toString() {
		return "JobPostingInfo [JobPostingID=" + JobPostingID + ", CompanyID=" + CompanyID + ", JobTitle=" + JobTitle
