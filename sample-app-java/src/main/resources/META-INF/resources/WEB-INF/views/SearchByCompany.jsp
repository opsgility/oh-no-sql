...
<c:set value="${companyName}" var="company" />
    <form:form action="/SearchByCompany" method="GET" class="base-content job-search-layout">
            ...
            <th>${message}</th>
              ...
              <c:forEach items="${jobsPageList.pageList}" var="job">   
                <tr>
                    <td ></td>
                    <td>
                      <form:form action="${pageContext.request.contextPath}/SearchByCompny" method="GET">
