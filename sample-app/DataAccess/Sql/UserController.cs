...
namespace DataAccess.Sql
{
    public static class UserController
    {
        ...
        public async static Task<IEnumerable<SkillInfo>> GetSkillByUserIdAsync(string UserId)
        {
            List<ParameterInfo> parameters = new List<ParameterInfo>();
            parameters.Add(new ParameterInfo() { ParameterName = "UserId", ParameterValue = UserId });
            return await SqlHelper.GetRecordsAsync<SkillInfo>("GetSkillsByUserId", parameters);
        }
